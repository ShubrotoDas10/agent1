...
DATABASE_URL = os.getenv("DATABASE_URL", "postgresql+psycopg2://postgres.hqitqjhmmcuqlofrqhnf:Shubroto123@aws-0-ap-northeast-1.pooler.supabase.com:6543/postgres?sslmode=require")
